...
var Timer = /*#__PURE__*/function () {
  ...
  _createClass(Timer, [{
    ...
    key: "isChargingZeroIncluded",
    value: function isChargingZeroIncluded() {
...
var Player = /*#__PURE__*/function () {
...

    {
      ...
      this.frameHandler = {
        ...
        isIdle: function isIdle() {
          return this.frame == '<img class="pl" src=' + this.blobImages.idleImg + " />";
        },
  ...
  _createClass(Player, [{
    ...
    value: function handleAttack(inputHandler, timeDifferential, playerB) {
      var isCharging = inputHandler.isXPressed() && this.chargeTimer.isChargingZeroIncluded();
      var shouldReleaseSmallShot = !inputHandler.isXPressed() && this.chargeTimer.isCharging();
      var shouldReleaseChargeShot = !inputHandler.isXPressed() && this.chargeTimer.isCharged();
      var isFullyCharged = inputHandler.isXPressed() && this.chargeTimer.isCharged();
      var isSpecialFilling = this.specialTimer.isChargingZeroIncluded();
      var isSpecialFull = this.specialTimer.isCharged(); //Attacks
...
var Game = /*#__PURE__*/function () {
  ...
  _createClass(Game, [{
    ...
    value: function update(timeDifferential) {
      //1: Get the game pads
      if (length(this.playerInputs) < 2) {
        this.state.changeToPaused(); // overlay.show();
      ...
      if (this.state.isOngoing()) {
        ...
        } else {// console.log("Gamepads are disconnected!");
        }
    ...
    value: function endGame(winner, loser) {
      ...
      overlay.children()[0].innerText = "Game Over! Player ".concat(winner.ID, " wins!");
      overlay.show();
    }
  }, {
    key: "togglePause",
...
},{"./Grid.js":"JS/Grid.js","./Player.js":"JS/Player.js","./jQuery.js":"JS/jQuery.js"}],"JS/InputHandler.js":[function(require,module,exports) {
"use strict";
...
var _jQuery = _interopRequireDefault(require("./JS/jQuery.js"));

var _Game = _interopRequireDefault(require("./JS/Game.js"));

var _InputHandler = _interopRequireDefault(require("./JS/InputHandler.js"));
...
window.requestAnimationFrame(gameLoop);
},{"./JS/jQuery.js":"JS/jQuery.js","./JS/Game.js":"JS/Game.js","./JS/InputHandler.js":"JS/InputHandler.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
